...
const AddEducation = ({ addEducation, history }) => {
    ...
    return (
        <Fragment>
            ...
            <p class="lead">
                <i class="fas fa-code-branch"></i> Add any school/bootcamp that you have had in the past
            </p>
            ...
            <form class="form" onSubmit={e => {
                ...
                <div class="form-group">
                    <p><input id="current" type="checkbox" name="current" checked={current} value={current} onChange={
                        () => {
                            setFormData({
                    ...
                    } />{' '} <label htmlFor="current">Current School</label></p>
                </div>
                <div class="form-group">
                    <h4>To Date</h4>
